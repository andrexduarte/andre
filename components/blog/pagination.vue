<template>
    <div class="pagination-list text-typography_primary">
        <!-- Chevron -->
        <nuxt-link v-show="currentPage > 1" class="pagination-item pagination-icon" :to="prevLink"><IconsChevronDown width="24" height="24"/></nuxt-link>
        <!-- First Page -->
        ...
        <!-- Chevron -->
        <nuxt-link v-show="currentPage < totalPages" class="pagination-item pagination-icon" :to="getPageUrl(currentPage + 1)"><IconsChevronDown width="24" height="24"/></nuxt-link>
    </div>
</template>
